...
--[[
	Graphite: Simple Vector2 Class

	This demonstrates how to create a simple Vector2 class in Graphite.
...
local Vector2 = Graphite.OOP:Class()
	:Members {
		0, 0
	}
...
print("one: " .. one:ToString()) -- Graphite-style
